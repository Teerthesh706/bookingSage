...
// // // const SeatSelection = ({ show }) => {
// // //   const [selectedSeats, setSelectedSeats] = useState([]);

// // //   const handleLock = async () => {
// // //     try {
// // //       const { data } = await API.post("/shows/lock", {
// // //         showId: show._id,
// // //         seats: selectedSeats,
// // //       });
...
// //         onClick={handleLock}
// //         disabled={locking}
// //         className="mt-6 bg-red-600 px-6 py-3 rounded hover:bg-red-700 disabled:opacity-50"
// //       >
...
// //         className="mt-4 ml-4 bg-green-600 px-6 py-3 rounded hover:bg-green-700 disabled:opacity-50"
// //       >
...
//   if (!show) return <div className="p-10">Loading show...</div>;
